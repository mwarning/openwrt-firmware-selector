...
def scan(args):
    ...
    for path in Path(args.release_path).rglob("profiles.json"):
...
Usage Examples:
    ./misc/collect.py scan ~/openwrt/bin 'https://downloads.openwrt.org/{base}/{target}' www/
    or
    ./misc/collect.py scrape https://downloads.openwrt.org 'https://downloads.openwrt.org/{base}/{target}' www/
    """,
    ...
    parser_scrape.add_argument("release_url", help="Domain to scrape.")
    parser_scrape.add_argument("image_url", help="URL template to download images.")
    parser_scrape.add_argument("www_path", help="Path of the config.js.")
    ...
    parser_scan.add_argument("release_path", help="Directory to scan for releases.")
    parser_scan.add_argument("image_url", help="URL template to download images.")
    parser_scan.add_argument("www_path", help="Path of the config.js.")
